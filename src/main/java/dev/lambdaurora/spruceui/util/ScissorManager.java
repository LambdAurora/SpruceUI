 ...
 * @version 3.2.1
 * @since 2.0.0
 * @deprecated Fully removed in SpruceUI 6.0 on 1.21.4+,
 * use {@link net.minecraft.client.gui.GuiGraphics}'s scissor handling instead.
 */
...
public final class ScissorManager {
	...
	private static int adaptY(int y, int height, double scaleFactor) {
		...
		int scaledHeight = window.getWidth() / scaleFactor > (double) tmpHeight ? tmpHeight + 1 : tmpHeight;
